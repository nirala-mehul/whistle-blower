...
export interface ExecutedSignedTransactionDto
  extends ExecutedTransactionDtoInner {
  from: string;
  interactionJarHash: string;
}

export type ExecutedTransactionDto =
  | ExecutedEventTransactionDto
  | ExecutedSignedTransactionDto;
